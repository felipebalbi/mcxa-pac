...
impl W {
    #[doc = "Bit 0 - Transmit Data DMA Enable"]
    #[inline(always)]
    pub fn tdde(&mut self) -> TddeW<'_, SderSpec> {
        TddeW::new(self, 0)
    }
    #[doc = "Bit 1 - Receive Data DMA Enable"]
    #[inline(always)]
    pub fn rdde(&mut self) -> RddeW<'_, SderSpec> {
        RddeW::new(self, 1)
    }
    #[doc = "Bit 2 - Address Valid DMA Enable"]
    #[inline(always)]
    pub fn avde(&mut self) -> AvdeW<'_, SderSpec> {
        AvdeW::new(self, 2)
    }
    #[doc = "Bit 8 - Repeated Start DMA Enable"]
    #[inline(always)]
    pub fn rsde(&mut self) -> RsdeW<'_, SderSpec> {
        RsdeW::new(self, 8)
    }
    #[doc = "Bit 9 - Stop Detect DMA Enable"]
    #[inline(always)]
    pub fn sdde(&mut self) -> SddeW<'_, SderSpec> {
        SddeW::new(self, 9)
    }
}
