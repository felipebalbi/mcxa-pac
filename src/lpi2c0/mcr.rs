...
impl W {
    #[doc = "Bit 0 - Controller Enable"]
    #[inline(always)]
    pub fn men(&mut self) -> MenW<'_, McrSpec> {
        MenW::new(self, 0)
    }
    #[doc = "Bit 1 - Software Reset"]
    #[inline(always)]
    pub fn rst(&mut self) -> RstW<'_, McrSpec> {
        RstW::new(self, 1)
    }
    #[doc = "Bit 2 - Doze Mode Enable"]
    #[inline(always)]
    pub fn dozen(&mut self) -> DozenW<'_, McrSpec> {
        DozenW::new(self, 2)
    }
    #[doc = "Bit 3 - Debug Enable"]
    #[inline(always)]
    pub fn dbgen(&mut self) -> DbgenW<'_, McrSpec> {
        DbgenW::new(self, 3)
    }
    #[doc = "Bit 8 - Reset Transmit FIFO"]
    #[inline(always)]
    pub fn rtf(&mut self) -> RtfW<'_, McrSpec> {
        RtfW::new(self, 8)
    }
    #[doc = "Bit 9 - Reset Receive FIFO"]
    #[inline(always)]
    pub fn rrf(&mut self) -> RrfW<'_, McrSpec> {
        RrfW::new(self, 9)
    }
}
