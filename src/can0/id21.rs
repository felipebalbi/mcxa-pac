...
pub type R = crate::R<Id21Spec>;
#[doc = "Register `ID21` writer"]
pub type W = crate::W<Id21Spec>;
...
impl W {
    #[doc = "Bits 0:17 - Contains extended (LOW word) identifier of message buffer."]
    #[inline(always)]
    pub fn ext(&mut self) -> ExtW<'_, Id21Spec> {
        ExtW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Contains standard/extended (HIGH word) identifier of message buffer."]
    #[inline(always)]
    pub fn std(&mut self) -> StdW<'_, Id21Spec> {
        StdW::new(self, 18)
    }
    #[doc = "Bits 29:31 - Local priority. This 3-bit fieldis only used when LPRIO_EN bit is set in MCR and it only makes sense for Tx buffers. These bits are not transmitted. They are appended to the regular ID to define the transmission priority."]
    #[inline(always)]
    pub fn prio(&mut self) -> PrioW<'_, Id21Spec> {
        PrioW::new(self, 29)
    }
}
#[doc = "Message Buffer 21 ID Register\n\nYou can [`read`](crate::Reg::read) this register and get [`id21::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`id21::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Id21Spec;
impl crate::RegisterSpec for Id21Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`id21::R`](R) reader structure"]
impl crate::Readable for Id21Spec {}
#[doc = "`write(|w| ..)` method takes [`id21::W`](W) writer structure"]
impl crate::Writable for Id21Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ID21 to value 0"]
impl crate::Resettable for Id21Spec {}
