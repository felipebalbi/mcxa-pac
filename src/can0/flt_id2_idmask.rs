...
impl W {
    #[doc = "Bits 0:28 - ID Filter 2 for Pretended Networking Filtering or ID Mask Bits for Pretended Networking ID Filtering"]
    #[inline(always)]
    pub fn flt_id2_idmask(&mut self) -> FltId2IdmaskW<'_, FltId2IdmaskSpec> {
        FltId2IdmaskW::new(self, 0)
    }
    #[doc = "Bit 29 - Remote Transmission Request Mask"]
    #[inline(always)]
    pub fn rtr_msk(&mut self) -> RtrMskW<'_, FltId2IdmaskSpec> {
        RtrMskW::new(self, 29)
    }
    #[doc = "Bit 30 - ID Extended Mask"]
    #[inline(always)]
    pub fn ide_msk(&mut self) -> IdeMskW<'_, FltId2IdmaskSpec> {
        IdeMskW::new(self, 30)
    }
}
