...
pub type R = crate::R<Id19Spec>;
#[doc = "Register `ID19` writer"]
pub type W = crate::W<Id19Spec>;
...
impl W {
    #[doc = "Bits 0:17 - Contains extended (LOW word) identifier of message buffer."]
    #[inline(always)]
    pub fn ext(&mut self) -> ExtW<'_, Id19Spec> {
        ExtW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Contains standard/extended (HIGH word) identifier of message buffer."]
    #[inline(always)]
    pub fn std(&mut self) -> StdW<'_, Id19Spec> {
        StdW::new(self, 18)
    }
    #[doc = "Bits 29:31 - Local priority. This 3-bit fieldis only used when LPRIO_EN bit is set in MCR and it only makes sense for Tx buffers. These bits are not transmitted. They are appended to the regular ID to define the transmission priority."]
    #[inline(always)]
    pub fn prio(&mut self) -> PrioW<'_, Id19Spec> {
        PrioW::new(self, 29)
    }
}
#[doc = "Message Buffer 19 ID Register\n\nYou can [`read`](crate::Reg::read) this register and get [`id19::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`id19::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Id19Spec;
impl crate::RegisterSpec for Id19Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`id19::R`](R) reader structure"]
impl crate::Readable for Id19Spec {}
#[doc = "`write(|w| ..)` method takes [`id19::W`](W) writer structure"]
impl crate::Writable for Id19Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ID19 to value 0"]
impl crate::Resettable for Id19Spec {}
