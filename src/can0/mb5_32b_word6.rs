...
pub type R = crate::R<Mb5_32bWord6Spec>;
#[doc = "Register `MB5_32B_WORD6` writer"]
pub type W = crate::W<Mb5_32bWord6Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_27(&mut self) -> DataByte27W<'_, Mb5_32bWord6Spec> {
        DataByte27W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_26(&mut self) -> DataByte26W<'_, Mb5_32bWord6Spec> {
        DataByte26W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_25(&mut self) -> DataByte25W<'_, Mb5_32bWord6Spec> {
        DataByte25W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_24(&mut self) -> DataByte24W<'_, Mb5_32bWord6Spec> {
        DataByte24W::new(self, 24)
    }
}
#[doc = "Message Buffer 5 WORD_32B Register\n\nYou can [`read`](crate::Reg::read) this register and get [`mb5_32b_word6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mb5_32b_word6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mb5_32bWord6Spec;
impl crate::RegisterSpec for Mb5_32bWord6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb5_32b_word6::R`](R) reader structure"]
impl crate::Readable for Mb5_32bWord6Spec {}
#[doc = "`write(|w| ..)` method takes [`mb5_32b_word6::W`](W) writer structure"]
impl crate::Writable for Mb5_32bWord6Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB5_32B_WORD6 to value 0"]
impl crate::Resettable for Mb5_32bWord6Spec {}
