...
pub type R = crate::R<Mb10_32bIdSpec>;
#[doc = "Register `MB10_32B_ID` writer"]
pub type W = crate::W<Mb10_32bIdSpec>;
...
impl W {
    #[doc = "Bits 0:17 - Contains extended (LOW word) identifier of message buffer."]
    #[inline(always)]
    pub fn ext(&mut self) -> ExtW<'_, Mb10_32bIdSpec> {
        ExtW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Contains standard/extended (HIGH word) identifier of message buffer."]
    #[inline(always)]
    pub fn std(&mut self) -> StdW<'_, Mb10_32bIdSpec> {
        StdW::new(self, 18)
    }
    #[doc = "Bits 29:31 - Local priority. This 3-bit fieldis only used when LPRIO_EN bit is set in MCR and it only makes sense for Tx buffers. These bits are not transmitted. They are appended to the regular ID to define the transmission priority."]
    #[inline(always)]
    pub fn prio(&mut self) -> PrioW<'_, Mb10_32bIdSpec> {
        PrioW::new(self, 29)
    }
}
#[doc = "Message Buffer 10 ID Register\n\nYou can [`read`](crate::Reg::read) this register and get [`mb10_32b_id::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mb10_32b_id::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mb10_32bIdSpec;
impl crate::RegisterSpec for Mb10_32bIdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb10_32b_id::R`](R) reader structure"]
impl crate::Readable for Mb10_32bIdSpec {}
#[doc = "`write(|w| ..)` method takes [`mb10_32b_id::W`](W) writer structure"]
impl crate::Writable for Mb10_32bIdSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB10_32B_ID to value 0"]
impl crate::Resettable for Mb10_32bIdSpec {}
