...
impl W {
    #[doc = "Bits 0:4 - Enhanced RX FIFO Watermark"]
    #[inline(always)]
    pub fn erfwm(&mut self) -> ErfwmW<'_, ErfcrSpec> {
        ErfwmW::new(self, 0)
    }
    #[doc = "Bits 8:13 - Number of Enhanced RX FIFO Filter Elements"]
    #[inline(always)]
    pub fn nfe(&mut self) -> NfeW<'_, ErfcrSpec> {
        NfeW::new(self, 8)
    }
    #[doc = "Bits 16:22 - Number of Extended ID Filter Elements"]
    #[inline(always)]
    pub fn nexif(&mut self) -> NexifW<'_, ErfcrSpec> {
        NexifW::new(self, 16)
    }
    #[doc = "Bits 26:30 - DMA Last Word"]
    #[inline(always)]
    pub fn dmalw(&mut self) -> DmalwW<'_, ErfcrSpec> {
        DmalwW::new(self, 26)
    }
    #[doc = "Bit 31 - Enhanced RX FIFO enable"]
    #[inline(always)]
    pub fn erfen(&mut self) -> ErfenW<'_, ErfcrSpec> {
        ErfenW::new(self, 31)
    }
}
