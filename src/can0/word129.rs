...
pub type R = crate::R<Word129Spec>;
#[doc = "Register `WORD129` writer"]
pub type W = crate::W<Word129Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_7(&mut self) -> DataByte7W<'_, Word129Spec> {
        DataByte7W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_6(&mut self) -> DataByte6W<'_, Word129Spec> {
        DataByte6W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_5(&mut self) -> DataByte5W<'_, Word129Spec> {
        DataByte5W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_4(&mut self) -> DataByte4W<'_, Word129Spec> {
        DataByte4W::new(self, 24)
    }
}
#[doc = "Message Buffer 29 WORD1 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`word129::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`word129::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Word129Spec;
impl crate::RegisterSpec for Word129Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`word129::R`](R) reader structure"]
impl crate::Readable for Word129Spec {}
#[doc = "`write(|w| ..)` method takes [`word129::W`](W) writer structure"]
impl crate::Writable for Word129Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WORD129 to value 0"]
impl crate::Resettable for Word129Spec {}
