...
impl W {
    #[doc = "Bits 0:7 - Data Byte 7"]
    #[inline(always)]
    pub fn data_byte_7(&mut self) -> DataByte7W<'_, Pl2PlmaskHiSpec> {
        DataByte7W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data Byte 6"]
    #[inline(always)]
    pub fn data_byte_6(&mut self) -> DataByte6W<'_, Pl2PlmaskHiSpec> {
        DataByte6W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data Byte 5"]
    #[inline(always)]
    pub fn data_byte_5(&mut self) -> DataByte5W<'_, Pl2PlmaskHiSpec> {
        DataByte5W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data Byte 4"]
    #[inline(always)]
    pub fn data_byte_4(&mut self) -> DataByte4W<'_, Pl2PlmaskHiSpec> {
