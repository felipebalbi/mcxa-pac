...
pub type R = crate::R<Mb15_8bWord1Spec>;
#[doc = "Register `MB15_8B_WORD1` writer"]
pub type W = crate::W<Mb15_8bWord1Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_7(&mut self) -> DataByte7W<'_, Mb15_8bWord1Spec> {
        DataByte7W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_6(&mut self) -> DataByte6W<'_, Mb15_8bWord1Spec> {
        DataByte6W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_5(&mut self) -> DataByte5W<'_, Mb15_8bWord1Spec> {
        DataByte5W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_4(&mut self) -> DataByte4W<'_, Mb15_8bWord1Spec> {
        DataByte4W::new(self, 24)
    }
}
#[doc = "Message Buffer 15 WORD_8B Register\n\nYou can [`read`](crate::Reg::read) this register and get [`mb15_8b_word1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mb15_8b_word1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mb15_8bWord1Spec;
impl crate::RegisterSpec for Mb15_8bWord1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mb15_8b_word1::R`](R) reader structure"]
impl crate::Readable for Mb15_8bWord1Spec {}
#[doc = "`write(|w| ..)` method takes [`mb15_8b_word1::W`](W) writer structure"]
impl crate::Writable for Mb15_8bWord1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MB15_8B_WORD1 to value 0"]
impl crate::Resettable for Mb15_8bWord1Spec {}
