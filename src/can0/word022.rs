...
pub type R = crate::R<Word022Spec>;
#[doc = "Register `WORD022` writer"]
pub type W = crate::W<Word022Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_3(&mut self) -> DataByte3W<'_, Word022Spec> {
        DataByte3W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_2(&mut self) -> DataByte2W<'_, Word022Spec> {
        DataByte2W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_1(&mut self) -> DataByte1W<'_, Word022Spec> {
        DataByte1W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_0(&mut self) -> DataByte0W<'_, Word022Spec> {
        DataByte0W::new(self, 24)
    }
}
#[doc = "Message Buffer 22 WORD0 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`word022::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`word022::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Word022Spec;
impl crate::RegisterSpec for Word022Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`word022::R`](R) reader structure"]
impl crate::Readable for Word022Spec {}
#[doc = "`write(|w| ..)` method takes [`word022::W`](W) writer structure"]
impl crate::Writable for Word022Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WORD022 to value 0"]
impl crate::Resettable for Word022Spec {}
