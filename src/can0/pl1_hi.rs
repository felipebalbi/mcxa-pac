...
impl W {
    #[doc = "Bits 0:7 - Data byte 7"]
    #[inline(always)]
    pub fn data_byte_7(&mut self) -> DataByte7W<'_, Pl1HiSpec> {
        DataByte7W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 6"]
    #[inline(always)]
    pub fn data_byte_6(&mut self) -> DataByte6W<'_, Pl1HiSpec> {
        DataByte6W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 5"]
    #[inline(always)]
    pub fn data_byte_5(&mut self) -> DataByte5W<'_, Pl1HiSpec> {
        DataByte5W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 4"]
    #[inline(always)]
    pub fn data_byte_4(&mut self) -> DataByte4W<'_, Pl1HiSpec> {
