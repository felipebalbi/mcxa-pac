...
pub type R = crate::R<Word127Spec>;
#[doc = "Register `WORD127` writer"]
pub type W = crate::W<Word127Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Data byte 0 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_7(&mut self) -> DataByte7W<'_, Word127Spec> {
        DataByte7W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_6(&mut self) -> DataByte6W<'_, Word127Spec> {
        DataByte6W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_5(&mut self) -> DataByte5W<'_, Word127Spec> {
        DataByte5W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3 of Rx/Tx frame."]
    #[inline(always)]
    pub fn data_byte_4(&mut self) -> DataByte4W<'_, Word127Spec> {
        DataByte4W::new(self, 24)
    }
}
#[doc = "Message Buffer 27 WORD1 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`word127::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`word127::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Word127Spec;
impl crate::RegisterSpec for Word127Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`word127::R`](R) reader structure"]
impl crate::Readable for Word127Spec {}
#[doc = "`write(|w| ..)` method takes [`word127::W`](W) writer structure"]
impl crate::Writable for Word127Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WORD127 to value 0"]
impl crate::Resettable for Word127Spec {}
