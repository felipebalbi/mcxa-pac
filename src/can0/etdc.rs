...
impl W {
    #[doc = "Bit 15 - Transceiver Delay Compensation Fail"]
    #[inline(always)]
    pub fn etdcfail(&mut self) -> EtdcfailW<'_, EtdcSpec> {
        EtdcfailW::new(self, 15)
    }
    #[doc = "Bits 16:22 - Enhanced Transceiver Delay Compensation Offset"]
    #[inline(always)]
    pub fn etdcoff(&mut self) -> EtdcoffW<'_, EtdcSpec> {
        EtdcoffW::new(self, 16)
    }
    #[doc = "Bit 30 - Transceiver Delay Measurement Disable"]
    #[inline(always)]
    pub fn tdmdis(&mut self) -> TdmdisW<'_, EtdcSpec> {
        TdmdisW::new(self, 30)
    }
    #[doc = "Bit 31 - Transceiver Delay Compensation Enable"]
    #[inline(always)]
    pub fn etdcen(&mut self) -> EtdcenW<'_, EtdcSpec> {
        EtdcenW::new(self, 31)
    }
}
