...
pub type R = crate::R<Id31Spec>;
#[doc = "Register `ID31` writer"]
pub type W = crate::W<Id31Spec>;
...
impl W {
    #[doc = "Bits 0:17 - Contains extended (LOW word) identifier of message buffer."]
    #[inline(always)]
    pub fn ext(&mut self) -> ExtW<'_, Id31Spec> {
        ExtW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Contains standard/extended (HIGH word) identifier of message buffer."]
    #[inline(always)]
    pub fn std(&mut self) -> StdW<'_, Id31Spec> {
        StdW::new(self, 18)
    }
    #[doc = "Bits 29:31 - Local priority. This 3-bit fieldis only used when LPRIO_EN bit is set in MCR and it only makes sense for Tx buffers. These bits are not transmitted. They are appended to the regular ID to define the transmission priority."]
    #[inline(always)]
    pub fn prio(&mut self) -> PrioW<'_, Id31Spec> {
        PrioW::new(self, 29)
    }
}
#[doc = "Message Buffer 31 ID Register\n\nYou can [`read`](crate::Reg::read) this register and get [`id31::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`id31::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Id31Spec;
impl crate::RegisterSpec for Id31Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`id31::R`](R) reader structure"]
impl crate::Readable for Id31Spec {}
#[doc = "`write(|w| ..)` method takes [`id31::W`](W) writer structure"]
impl crate::Writable for Id31Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ID31 to value 0"]
impl crate::Resettable for Id31Spec {}
