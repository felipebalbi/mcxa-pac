...
impl W {
    #[doc = "Bits 0:2 - Count"]
    #[inline(always)]
    pub fn cnt(&mut self) -> CntW<'_, Ibiext1Spec> {
        CntW::new(self, 0)
    }
    #[doc = "Bits 8:15 - Extra Byte 1"]
    #[inline(always)]
    pub fn ext1(&mut self) -> Ext1W<'_, Ibiext1Spec> {
        Ext1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Extra Byte 2"]
    #[inline(always)]
    pub fn ext2(&mut self) -> Ext2W<'_, Ibiext1Spec> {
        Ext2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Extra Byte 3"]
    #[inline(always)]
    pub fn ext3(&mut self) -> Ext3W<'_, Ibiext1Spec> {
        Ext3W::new(self, 24)
    }
}
