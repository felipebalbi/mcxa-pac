...
impl W {
    ...
    #[inline(always)]
    pub fn flushtb(&mut self) -> FlushtbW<'_, SdatactrlSpec> {
        FlushtbW::new(self, 0)
    }
    #[doc = "Bit 1 - Flush From-Bus Buffer or FIFO"]
    #[inline(always)]
    pub fn flushfb(&mut self) -> FlushfbW<'_, SdatactrlSpec> {
        FlushfbW::new(self, 1)
    }
    #[doc = "Bit 3 - Unlock"]
    #[inline(always)]
    pub fn unlock(&mut self) -> UnlockW<'_, SdatactrlSpec> {
        UnlockW::new(self, 3)
    }
    #[doc = "Bits 4:5 - Transmit Trigger Level"]
    #[inline(always)]
    pub fn txtrig(&mut self) -> TxtrigW<'_, SdatactrlSpec> {
        TxtrigW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Receive Trigger Level"]
    #[inline(always)]
    pub fn rxtrig(&mut self) -> RxtrigW<'_, SdatactrlSpec> {
        RxtrigW::new(self, 6)
    }
}
