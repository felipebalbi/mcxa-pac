...
impl W {
    #[doc = "Bit 8 - START Interrupt Enable Clear Flag"]
    #[inline(always)]
    pub fn start(&mut self) -> StartW<'_, SintclrSpec> {
        StartW::new(self, 8)
    }
    #[doc = "Bit 9 - Matched Interrupt Enable Clear Flag"]
    #[inline(always)]
    pub fn matched(&mut self) -> MatchedW<'_, SintclrSpec> {
        MatchedW::new(self, 9)
    }
    #[doc = "Bit 10 - STOP Interrupt Enable Clear Flag"]
    #[inline(always)]
    pub fn stop(&mut self) -> StopW<'_, SintclrSpec> {
        StopW::new(self, 10)
    }
    #[doc = "Bit 11 - RXPEND Interrupt Enable Clear Flag"]
    #[inline(always)]
    pub fn rxpend(&mut self) -> RxpendW<'_, SintclrSpec> {
        RxpendW::new(self, 11)
    }
    #[doc = "Bit 12 - TXSEND Interrupt Enable Clear Flag"]
    #[inline(always)]
    pub fn txsend(&mut self) -> TxsendW<'_, SintclrSpec> {
        TxsendW::new(self, 12)
    }
    #[doc = "Bit 13 - DACHG Interrupt Enable Clear Flag"]
    #[inline(always)]
    pub fn dachg(&mut self) -> DachgW<'_, SintclrSpec> {
        DachgW::new(self, 13)
    }
    #[doc = "Bit 14 - CCC Interrupt Enable Clear Flag"]
    #[inline(always)]
    pub fn ccc(&mut self) -> CccW<'_, SintclrSpec> {
        CccW::new(self, 14)
    }
    #[doc = "Bit 15 - ERRWARN Interrupt Enable Clear Flag"]
    #[inline(always)]
    pub fn errwarn(&mut self) -> ErrwarnW<'_, SintclrSpec> {
        ErrwarnW::new(self, 15)
    }
    #[doc = "Bit 16 - DDRMATCHED Interrupt Enable Clear Flag"]
    #[inline(always)]
    pub fn ddrmatched(&mut self) -> DdrmatchedW<'_, SintclrSpec> {
        DdrmatchedW::new(self, 16)
    }
    #[doc = "Bit 17 - CHANDLED Interrupt Enable Clear Flag"]
    #[inline(always)]
    pub fn chandled(&mut self) -> ChandledW<'_, SintclrSpec> {
        ChandledW::new(self, 17)
    }
    #[doc = "Bit 18 - EVENT Interrupt Enable Clear Flag"]
    #[inline(always)]
    pub fn event(&mut self) -> EventW<'_, SintclrSpec> {
        EventW::new(self, 18)
    }
}
