...
impl W {
    #[doc = "Bits 0:7 - Extra Byte 4"]
    #[inline(always)]
    pub fn ext4(&mut self) -> Ext4W<'_, Ibiext2Spec> {
        Ext4W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Extra Byte 5"]
    #[inline(always)]
    pub fn ext5(&mut self) -> Ext5W<'_, Ibiext2Spec> {
        Ext5W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Extra Byte 6"]
    #[inline(always)]
    pub fn ext6(&mut self) -> Ext6W<'_, Ibiext2Spec> {
        Ext6W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Extra Byte 7"]
    #[inline(always)]
    pub fn ext7(&mut self) -> Ext7W<'_, Ibiext2Spec> {
        Ext7W::new(self, 24)
    }
}
