...
impl W {
    ...
    #[inline(always)]
    pub fn flushtb(&mut self) -> FlushtbW<'_, MdatactrlSpec> {
        FlushtbW::new(self, 0)
    }
    #[doc = "Bit 1 - Flush From-Bus Buffer or FIFO"]
    #[inline(always)]
    pub fn flushfb(&mut self) -> FlushfbW<'_, MdatactrlSpec> {
        FlushfbW::new(self, 1)
    }
    #[doc = "Bit 3 - Unlock"]
    #[inline(always)]
    pub fn unlock(&mut self) -> UnlockW<'_, MdatactrlSpec> {
        UnlockW::new(self, 3)
    }
    #[doc = "Bits 4:5 - Transmit Trigger Level"]
    #[inline(always)]
    pub fn txtrig(&mut self) -> TxtrigW<'_, MdatactrlSpec> {
        TxtrigW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Receive Trigger Level"]
    #[inline(always)]
    pub fn rxtrig(&mut self) -> RxtrigW<'_, MdatactrlSpec> {
        RxtrigW::new(self, 6)
    }
}
