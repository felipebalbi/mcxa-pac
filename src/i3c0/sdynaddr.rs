...
impl W {
    #[doc = "Bit 0 - Dynamic Address Valid"]
    #[inline(always)]
    pub fn davalid(&mut self) -> DavalidW<'_, SdynaddrSpec> {
        DavalidW::new(self, 0)
    }
    #[doc = "Bits 1:7 - Dynamic Address"]
    #[inline(always)]
    pub fn daddr(&mut self) -> DaddrW<'_, SdynaddrSpec> {
        DaddrW::new(self, 1)
    }
    #[doc = "Bit 12 - Map a Static Address"]
    #[inline(always)]
    pub fn mapsa(&mut self) -> MapsaW<'_, SdynaddrSpec> {
        MapsaW::new(self, 12)
    }
    #[doc = "Bits 13:15 - 10-Bit Static Address"]
    #[inline(always)]
    pub fn sa10b(&mut self) -> Sa10bW<'_, SdynaddrSpec> {
        Sa10bW::new(self, 13)
    }
    #[doc = "Bits 16:31 - Key"]
    #[inline(always)]
    pub fn key(&mut self) -> KeyW<'_, SdynaddrSpec> {
        KeyW::new(self, 16)
    }
}
