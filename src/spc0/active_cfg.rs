...
impl W {
    #[doc = "Bit 0 - LDO_CORE VDD Drive Strength"]
    #[inline(always)]
    pub fn coreldo_vdd_ds(&mut self) -> CoreldoVddDsW<'_, ActiveCfgSpec> {
        CoreldoVddDsW::new(self, 0)
    }
    #[doc = "Bits 2:3 - LDO_CORE VDD Regulator Voltage Level"]
    #[inline(always)]
    pub fn coreldo_vdd_lvl(&mut self) -> CoreldoVddLvlW<'_, ActiveCfgSpec> {
        CoreldoVddLvlW::new(self, 2)
    }
    #[doc = "Bits 20:21 - Bandgap Mode"]
    #[inline(always)]
    pub fn bgmode(&mut self) -> BgmodeW<'_, ActiveCfgSpec> {
        BgmodeW::new(self, 20)
    }
    #[doc = "Bit 23 - VDD Voltage Detect Disable"]
    #[inline(always)]
    pub fn vdd_vd_disable(&mut self) -> VddVdDisableW<'_, ActiveCfgSpec> {
        VddVdDisableW::new(self, 23)
    }
    #[doc = "Bit 24 - Core Low-Voltage Detection Enable"]
    #[inline(always)]
    pub fn core_lvde(&mut self) -> CoreLvdeW<'_, ActiveCfgSpec> {
        CoreLvdeW::new(self, 24)
    }
    #[doc = "Bit 25 - System Low-Voltage Detection Enable"]
    #[inline(always)]
    pub fn sys_lvde(&mut self) -> SysLvdeW<'_, ActiveCfgSpec> {
        SysLvdeW::new(self, 25)
    }
    #[doc = "Bit 28 - System High-Voltage Detection Enable"]
    #[inline(always)]
    pub fn sys_hvde(&mut self) -> SysHvdeW<'_, ActiveCfgSpec> {
