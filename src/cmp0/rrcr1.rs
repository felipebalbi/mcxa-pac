...
impl W {
    #[doc = "Bit 0 - Channel 0 Input Enable in Trigger Mode"]
    #[inline(always)]
    pub fn rr_ch0en(&mut self) -> RrCh0enW<'_, Rrcr1Spec> {
        RrCh0enW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel 1 Input Enable in Trigger Mode"]
    #[inline(always)]
    pub fn rr_ch1en(&mut self) -> RrCh1enW<'_, Rrcr1Spec> {
        RrCh1enW::new(self, 1)
    }
    #[doc = "Bit 2 - Channel 2 Input Enable in Trigger Mode"]
    #[inline(always)]
    pub fn rr_ch2en(&mut self) -> RrCh2enW<'_, Rrcr1Spec> {
        RrCh2enW::new(self, 2)
    }
    #[doc = "Bit 3 - Channel 3 Input Enable in Trigger Mode"]
    #[inline(always)]
    pub fn rr_ch3en(&mut self) -> RrCh3enW<'_, Rrcr1Spec> {
        RrCh3enW::new(self, 3)
    }
    #[doc = "Bit 4 - Channel 4 Input Enable in Trigger Mode"]
    #[inline(always)]
    pub fn rr_ch4en(&mut self) -> RrCh4enW<'_, Rrcr1Spec> {
        RrCh4enW::new(self, 4)
    }
    #[doc = "Bit 5 - Channel 5 Input Enable in Trigger Mode"]
    #[inline(always)]
    pub fn rr_ch5en(&mut self) -> RrCh5enW<'_, Rrcr1Spec> {
        RrCh5enW::new(self, 5)
    }
    #[doc = "Bit 6 - Channel 6 Input Enable in Trigger Mode"]
    #[inline(always)]
    pub fn rr_ch6en(&mut self) -> RrCh6enW<'_, Rrcr1Spec> {
        RrCh6enW::new(self, 6)
    }
    #[doc = "Bit 7 - Channel 7 Input Enable in Trigger Mode"]
    #[inline(always)]
    pub fn rr_ch7en(&mut self) -> RrCh7enW<'_, Rrcr1Spec> {
        RrCh7enW::new(self, 7)
    }
    #[doc = "Bit 16 - Fixed Port"]
    #[inline(always)]
    pub fn fixp(&mut self) -> FixpW<'_, Rrcr1Spec> {
        FixpW::new(self, 16)
    }
    #[doc = "Bits 20:22 - Fixed Channel Select"]
    #[inline(always)]
    pub fn fixch(&mut self) -> FixchW<'_, Rrcr1Spec> {
        FixchW::new(self, 20)
    }
}
