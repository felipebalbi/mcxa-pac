...
impl W {
    #[doc = "Bits 0:1 - Product Term 1, Input D Configuration"]
    #[inline(always)]
    pub fn pt1_dc(&mut self) -> Pt1DcW<'_, Bfcrt012Spec> {
        Pt1DcW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Product Term 1, Input C Configuration"]
    #[inline(always)]
    pub fn pt1_cc(&mut self) -> Pt1CcW<'_, Bfcrt012Spec> {
        Pt1CcW::new(self, 2)
    }
    #[doc = "Bits 4:5 - Product Term 1, Input B Configuration"]
    #[inline(always)]
    pub fn pt1_bc(&mut self) -> Pt1BcW<'_, Bfcrt012Spec> {
        Pt1BcW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Product Term 1, Input A Configuration"]
    #[inline(always)]
    pub fn pt1_ac(&mut self) -> Pt1AcW<'_, Bfcrt012Spec> {
        Pt1AcW::new(self, 6)
    }
    #[doc = "Bits 8:9 - Product Term 0, Input D Configuration"]
    #[inline(always)]
    pub fn pt0_dc(&mut self) -> Pt0DcW<'_, Bfcrt012Spec> {
        Pt0DcW::new(self, 8)
    }
    #[doc = "Bits 10:11 - Product Term 0, Input C Configuration"]
    #[inline(always)]
    pub fn pt0_cc(&mut self) -> Pt0CcW<'_, Bfcrt012Spec> {
        Pt0CcW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Product Term 0, Input B Configuration"]
    #[inline(always)]
    pub fn pt0_bc(&mut self) -> Pt0BcW<'_, Bfcrt012Spec> {
        Pt0BcW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Product Term 0, Input A Configuration"]
    #[inline(always)]
    pub fn pt0_ac(&mut self) -> Pt0AcW<'_, Bfcrt012Spec> {
        Pt0AcW::new(self, 14)
    }
}
