...
impl W {
    #[doc = "Bits 0:1 - Product Term 3, Input D Configuration"]
    #[inline(always)]
    pub fn pt3_dc(&mut self) -> Pt3DcW<'_, Bfcrt230Spec> {
        Pt3DcW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Product Term 3, Input C Configuration"]
    #[inline(always)]
    pub fn pt3_cc(&mut self) -> Pt3CcW<'_, Bfcrt230Spec> {
        Pt3CcW::new(self, 2)
    }
    #[doc = "Bits 4:5 - Product Term 3, Input B Configuration"]
    #[inline(always)]
    pub fn pt3_bc(&mut self) -> Pt3BcW<'_, Bfcrt230Spec> {
        Pt3BcW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Product Term 3, Input A Configuration"]
    #[inline(always)]
    pub fn pt3_ac(&mut self) -> Pt3AcW<'_, Bfcrt230Spec> {
        Pt3AcW::new(self, 6)
    }
    #[doc = "Bits 8:9 - Product Term 2, Input D Configuration"]
    #[inline(always)]
    pub fn pt2_dc(&mut self) -> Pt2DcW<'_, Bfcrt230Spec> {
        Pt2DcW::new(self, 8)
    }
    #[doc = "Bits 10:11 - Product Term 2, Input C Configuration"]
    #[inline(always)]
    pub fn pt2_cc(&mut self) -> Pt2CcW<'_, Bfcrt230Spec> {
        Pt2CcW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Product Term 2, Input B Configuration"]
    #[inline(always)]
    pub fn pt2_bc(&mut self) -> Pt2BcW<'_, Bfcrt230Spec> {
        Pt2BcW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Product Term 2, Input A Configuration"]
    #[inline(always)]
    pub fn pt2_ac(&mut self) -> Pt2AcW<'_, Bfcrt230Spec> {
        Pt2AcW::new(self, 14)
    }
}
