...
impl W {
    #[doc = "Bit 0 - Wake-up Reset"]
    #[inline(always)]
    pub fn wakeup(&mut self) -> WakeupW<'_, SsrsSpec> {
        WakeupW::new(self, 0)
    }
    #[doc = "Bit 1 - Power-on Reset"]
    #[inline(always)]
    pub fn por(&mut self) -> PorW<'_, SsrsSpec> {
        PorW::new(self, 1)
    }
    #[doc = "Bit 4 - Warm Reset"]
    #[inline(always)]
    pub fn warm(&mut self) -> WarmW<'_, SsrsSpec> {
        WarmW::new(self, 4)
    }
    #[doc = "Bit 5 - Fatal Reset"]
    #[inline(always)]
    pub fn fatal(&mut self) -> FatalW<'_, SsrsSpec> {
        FatalW::new(self, 5)
    }
    #[doc = "Bit 8 - Pin Reset"]
    #[inline(always)]
    pub fn pin(&mut self) -> PinW<'_, SsrsSpec> {
        PinW::new(self, 8)
    }
    #[doc = "Bit 9 - DAP Reset"]
    #[inline(always)]
    pub fn dap(&mut self) -> DapW<'_, SsrsSpec> {
        DapW::new(self, 9)
    }
    #[doc = "Bit 10 - Reset Timeout"]
    #[inline(always)]
    pub fn rstack(&mut self) -> RstackW<'_, SsrsSpec> {
        RstackW::new(self, 10)
    }
    #[doc = "Bit 11 - Low Power Acknowledge Timeout Reset"]
    #[inline(always)]
    pub fn lpack(&mut self) -> LpackW<'_, SsrsSpec> {
        LpackW::new(self, 11)
    }
    #[doc = "Bit 12 - System Clock Generation Reset"]
    #[inline(always)]
    pub fn scg(&mut self) -> ScgW<'_, SsrsSpec> {
        ScgW::new(self, 12)
    }
    #[doc = "Bit 13 - Windowed Watchdog 0 Reset"]
    #[inline(always)]
    pub fn wwdt0(&mut self) -> Wwdt0W<'_, SsrsSpec> {
        Wwdt0W::new(self, 13)
    }
    #[doc = "Bit 14 - Software Reset"]
    #[inline(always)]
    pub fn sw(&mut self) -> SwW<'_, SsrsSpec> {
        SwW::new(self, 14)
    }
    #[doc = "Bit 15 - Lockup Reset"]
    #[inline(always)]
    pub fn lockup(&mut self) -> LockupW<'_, SsrsSpec> {
        LockupW::new(self, 15)
    }
    #[doc = "Bit 26 - Code Watchdog 0 Reset"]
    #[inline(always)]
    pub fn cdog0(&mut self) -> Cdog0W<'_, SsrsSpec> {
        Cdog0W::new(self, 26)
    }
    #[doc = "Bit 27 - Code Watchdog 1 Reset"]
    #[inline(always)]
    pub fn cdog1(&mut self) -> Cdog1W<'_, SsrsSpec> {
        Cdog1W::new(self, 27)
    }
    #[doc = "Bit 28 - JTAG System Reset"]
    #[inline(always)]
    pub fn jtag(&mut self) -> JtagW<'_, SsrsSpec> {
        JtagW::new(self, 28)
    }
    #[doc = "Bit 31 - Tamper Reset"]
    #[inline(always)]
    pub fn tamper(&mut self) -> TamperW<'_, SsrsSpec> {
        TamperW::new(self, 31)
    }
}
