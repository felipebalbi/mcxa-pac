...
impl W {
    #[doc = "Bit 3 - Selects the source for the initial FIRC trim fine value used after a reset."]
    #[inline(always)]
    pub fn trim_init_val_sel(&mut self) -> TrimInitValSelW<'_, ClkRecoverCtrlSpec> {
        TrimInitValSelW::new(self, 3)
    }
    #[doc = "Bit 5 - Restart from IFR Trim Value"]
    #[inline(always)]
    pub fn restart_ifrtrim_en(&mut self) -> RestartIfrtrimEnW<'_, ClkRecoverCtrlSpec> {
        RestartIfrtrimEnW::new(self, 5)
    }
    #[doc = "Bit 6 - Reset or Resume to Rough Phase Enable"]
    #[inline(always)]
    pub fn reset_resume_rough_en(&mut self) -> ResetResumeRoughEnW<'_, ClkRecoverCtrlSpec> {
        ResetResumeRoughEnW::new(self, 6)
    }
    #[doc = "Bit 7 - Crystal-Less USB Enable"]
    #[inline(always)]
    pub fn clock_recover_en(&mut self) -> ClockRecoverEnW<'_, ClkRecoverCtrlSpec> {
