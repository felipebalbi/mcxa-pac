...
impl W {
    #[doc = "Bit 0 - DAC Enable"]
    #[inline(always)]
    pub fn dacen(&mut self) -> DacenW<'_, GcrSpec> {
        DacenW::new(self, 0)
    }
    #[doc = "Bits 1:2 - DAC Reference Select"]
    #[inline(always)]
    pub fn dacrfs(&mut self) -> DacrfsW<'_, GcrSpec> {
        DacrfsW::new(self, 1)
    }
    #[doc = "Bit 3 - FIFO Enable"]
    #[inline(always)]
    pub fn fifoen(&mut self) -> FifoenW<'_, GcrSpec> {
        FifoenW::new(self, 3)
    }
    #[doc = "Bit 4 - Swing Back Mode"]
    #[inline(always)]
    pub fn swmd(&mut self) -> SwmdW<'_, GcrSpec> {
        SwmdW::new(self, 4)
    }
    #[doc = "Bit 5 - DAC Trigger Select"]
    #[inline(always)]
    pub fn trgsel(&mut self) -> TrgselW<'_, GcrSpec> {
        TrgselW::new(self, 5)
    }
    #[doc = "Bit 6 - DAC Periodic Trigger Mode Enable"]
    #[inline(always)]
    pub fn ptgen(&mut self) -> PtgenW<'_, GcrSpec> {
        PtgenW::new(self, 6)
    }
    #[doc = "Bits 8:11 - RCLK Cycles Before Data Latch"]
    #[inline(always)]
    pub fn latch_cyc(&mut self) -> LatchCycW<'_, GcrSpec> {
        LatchCycW::new(self, 8)
    }
    #[doc = "Bit 17 - Buffer Enable"]
    #[inline(always)]
    pub fn buf_en(&mut self) -> BufEnW<'_, GcrSpec> {
        BufEnW::new(self, 17)
    }
    #[doc = "Bit 20 - External On-Chip PTAT Current Reference Select"]
    #[inline(always)]
    pub fn iref_ptat_ext_sel(&mut self) -> IrefPtatExtSelW<'_, GcrSpec> {
        IrefPtatExtSelW::new(self, 20)
    }
    #[doc = "Bit 21 - External On-Chip ZTC Current Reference Select"]
    #[inline(always)]
    pub fn iref_ztc_ext_sel(&mut self) -> IrefZtcExtSelW<'_, GcrSpec> {
        IrefZtcExtSelW::new(self, 21)
    }
    #[doc = "Bit 23 - OPAMP as Buffer, Speed Control Signal"]
    #[inline(always)]
    pub fn buf_spd_ctrl(&mut self) -> BufSpdCtrlW<'_, GcrSpec> {
