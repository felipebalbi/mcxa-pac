...
pub type R = crate::R<TcdBiterElinkyesSpec>;
#[doc = "Register `TCD_BITER_ELINKYES` writer"]
pub type W = crate::W<TcdBiterElinkyesSpec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TCD_BITER_ELINKYES")
...
impl W {
    #[doc = "Bits 0:8 - Starting Major Iteration Count"]
    #[inline(always)]
    pub fn biter(&mut self) -> BiterW<'_, TcdBiterElinkyesSpec> {
        BiterW::new(self, 0)
    }
    #[doc = "Bits 9:11 - Link Channel Number"]
    #[inline(always)]
    pub fn linkch(&mut self) -> LinkchW<'_, TcdBiterElinkyesSpec> {
        LinkchW::new(self, 9)
    }
    #[doc = "Bit 15 - Enable Link"]
    #[inline(always)]
    pub fn elink(&mut self) -> ElinkW<'_, TcdBiterElinkyesSpec> {
        ElinkW::new(self, 15)
    }
}
#[doc = "TCD Beginning Major Loop Count (Minor Loop Channel Linking Enabled)\n\nYou can [`read`](crate::Reg::read) this register and get [`tcd_biter_elinkyes::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tcd_biter_elinkyes::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TcdBiterElinkyesSpec;
impl crate::RegisterSpec for TcdBiterElinkyesSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`tcd_biter_elinkyes::R`](R) reader structure"]
impl crate::Readable for TcdBiterElinkyesSpec {}
#[doc = "`write(|w| ..)` method takes [`tcd_biter_elinkyes::W`](W) writer structure"]
impl crate::Writable for TcdBiterElinkyesSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TCD_BITER_ELINKYES to value 0"]
impl crate::Resettable for TcdBiterElinkyesSpec {}
