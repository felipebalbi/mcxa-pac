...
pub type R = crate::R<TcdBiterElinknoSpec>;
#[doc = "Register `TCD_BITER_ELINKNO` writer"]
pub type W = crate::W<TcdBiterElinknoSpec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TCD_BITER_ELINKNO")
...
impl W {
    #[doc = "Bits 0:14 - Starting Major Iteration Count"]
    #[inline(always)]
    pub fn biter(&mut self) -> BiterW<'_, TcdBiterElinknoSpec> {
        BiterW::new(self, 0)
    }
    #[doc = "Bit 15 - Enables Link"]
    #[inline(always)]
    pub fn elink(&mut self) -> ElinkW<'_, TcdBiterElinknoSpec> {
        ElinkW::new(self, 15)
    }
}
...
pub struct TcdBiterElinknoSpec;
impl crate::RegisterSpec for TcdBiterElinknoSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`tcd_biter_elinkno::R`](R) reader structure"]
impl crate::Readable for TcdBiterElinknoSpec {}
#[doc = "`write(|w| ..)` method takes [`tcd_biter_elinkno::W`](W) writer structure"]
impl crate::Writable for TcdBiterElinknoSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TCD_BITER_ELINKNO to value 0"]
impl crate::Resettable for TcdBiterElinknoSpec {}
