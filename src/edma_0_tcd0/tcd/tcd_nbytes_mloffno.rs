...
pub type R = crate::R<TcdNbytesMloffnoSpec>;
#[doc = "Register `TCD_NBYTES_MLOFFNO` writer"]
pub type W = crate::W<TcdNbytesMloffnoSpec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TCD_NBYTES_MLOFFNO")
...
impl W {
    #[doc = "Bits 0:29 - Number of Bytes To Transfer Per Service Request"]
    #[inline(always)]
    pub fn nbytes(&mut self) -> NbytesW<'_, TcdNbytesMloffnoSpec> {
        NbytesW::new(self, 0)
    }
    #[doc = "Bit 30 - Destination Minor Loop Offset Enable"]
    #[inline(always)]
    pub fn dmloe(&mut self) -> DmloeW<'_, TcdNbytesMloffnoSpec> {
        DmloeW::new(self, 30)
    }
    #[doc = "Bit 31 - Source Minor Loop Offset Enable"]
    #[inline(always)]
    pub fn smloe(&mut self) -> SmloeW<'_, TcdNbytesMloffnoSpec> {
        SmloeW::new(self, 31)
    }
}
...
pub struct TcdNbytesMloffnoSpec;
impl crate::RegisterSpec for TcdNbytesMloffnoSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tcd_nbytes_mloffno::R`](R) reader structure"]
impl crate::Readable for TcdNbytesMloffnoSpec {}
#[doc = "`write(|w| ..)` method takes [`tcd_nbytes_mloffno::W`](W) writer structure"]
impl crate::Writable for TcdNbytesMloffnoSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TCD_NBYTES_MLOFFNO to value 0"]
impl crate::Resettable for TcdNbytesMloffnoSpec {}
