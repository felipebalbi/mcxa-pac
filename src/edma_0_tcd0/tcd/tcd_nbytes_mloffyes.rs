...
pub type R = crate::R<TcdNbytesMloffyesSpec>;
#[doc = "Register `TCD_NBYTES_MLOFFYES` writer"]
pub type W = crate::W<TcdNbytesMloffyesSpec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TCD_NBYTES_MLOFFYES")
...
impl W {
    #[doc = "Bits 0:9 - Number of Bytes To Transfer Per Service Request"]
    #[inline(always)]
    pub fn nbytes(&mut self) -> NbytesW<'_, TcdNbytesMloffyesSpec> {
        NbytesW::new(self, 0)
    }
    #[doc = "Bits 10:29 - Minor Loop Offset"]
    #[inline(always)]
    pub fn mloff(&mut self) -> MloffW<'_, TcdNbytesMloffyesSpec> {
        MloffW::new(self, 10)
    }
    #[doc = "Bit 30 - Destination Minor Loop Offset Enable"]
    #[inline(always)]
    pub fn dmloe(&mut self) -> DmloeW<'_, TcdNbytesMloffyesSpec> {
        DmloeW::new(self, 30)
    }
    #[doc = "Bit 31 - Source Minor Loop Offset Enable"]
    #[inline(always)]
    pub fn smloe(&mut self) -> SmloeW<'_, TcdNbytesMloffyesSpec> {
        SmloeW::new(self, 31)
    }
}
...
pub struct TcdNbytesMloffyesSpec;
impl crate::RegisterSpec for TcdNbytesMloffyesSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tcd_nbytes_mloffyes::R`](R) reader structure"]
impl crate::Readable for TcdNbytesMloffyesSpec {}
#[doc = "`write(|w| ..)` method takes [`tcd_nbytes_mloffyes::W`](W) writer structure"]
impl crate::Writable for TcdNbytesMloffyesSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TCD_NBYTES_MLOFFYES to value 0"]
impl crate::Resettable for TcdNbytesMloffyesSpec {}
