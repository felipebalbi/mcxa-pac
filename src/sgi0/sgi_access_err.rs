...
impl W {
    #[doc = "Bit 0 - APB Error: address not available"]
    #[inline(always)]
    pub fn apb_notav(&mut self) -> ApbNotavW<'_, SgiAccessErrSpec> {
        ApbNotavW::new(self, 0)
    }
    #[doc = "Bit 1 - APB Error: Wrong access mode"]
    #[inline(always)]
    pub fn apb_wrgmd(&mut self) -> ApbWrgmdW<'_, SgiAccessErrSpec> {
        ApbWrgmdW::new(self, 1)
    }
    #[doc = "Bits 4:7 - APB Master that triggered first APB error"]
    #[inline(always)]
    pub fn apb_master(&mut self) -> ApbMasterW<'_, SgiAccessErrSpec> {
