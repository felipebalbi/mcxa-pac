...
impl W {
    #[doc = "Bit 0 - SHA enable"]
    #[inline(always)]
    pub fn sha2_en(&mut self) -> Sha2EnW<'_, SgiSha2CtrlSpec> {
        Sha2EnW::new(self, 0)
    }
    #[doc = "Bit 1 - SHA mode normal or automatic"]
    #[inline(always)]
    pub fn sha2_mode(&mut self) -> Sha2ModeW<'_, SgiSha2CtrlSpec> {
        Sha2ModeW::new(self, 1)
    }
    #[doc = "Bits 2:3 - SHA size 0=224;1=256;2=384;3=512"]
    #[inline(always)]
    pub fn sha2_size(&mut self) -> Sha2SizeW<'_, SgiSha2CtrlSpec> {
        Sha2SizeW::new(self, 2)
    }
    #[doc = "Bits 4:7 - SHA FIFO low limit"]
    #[inline(always)]
    pub fn sha2_low_lim(&mut self) -> Sha2LowLimW<'_, SgiSha2CtrlSpec> {
        Sha2LowLimW::new(self, 4)
    }
    #[doc = "Bits 8:11 - SHA FIFO high limit"]
    #[inline(always)]
    pub fn sha2_high_lim(&mut self) -> Sha2HighLimW<'_, SgiSha2CtrlSpec> {
        Sha2HighLimW::new(self, 8)
    }
    #[doc = "Bit 12 - SHA Calculation counter enable"]
    #[inline(always)]
    pub fn sha2_count_en(&mut self) -> Sha2CountEnW<'_, SgiSha2CtrlSpec> {
        Sha2CountEnW::new(self, 12)
    }
    #[doc = "Bit 13 - SHA HASH reload"]
    #[inline(always)]
    pub fn hash_reload(&mut self) -> HashReloadW<'_, SgiSha2CtrlSpec> {
        HashReloadW::new(self, 13)
    }
    #[doc = "Bit 14 - STOP SHA AUTO mode"]
    #[inline(always)]
    pub fn sha2_stop(&mut self) -> Sha2StopW<'_, SgiSha2CtrlSpec> {
        Sha2StopW::new(self, 14)
    }
    #[doc = "Bit 15 - SHA no automatic HASH initialisation"]
    #[inline(always)]
    pub fn no_auto_init(&mut self) -> NoAutoInitW<'_, SgiSha2CtrlSpec> {
