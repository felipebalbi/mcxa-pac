...
impl W {
    #[doc = "Bit 0 - TRIM_UNLOCK"]
    #[inline(always)]
    pub fn trim_unlock(&mut self) -> TrimUnlockW<'_, TrimLockSpec> {
        TrimUnlockW::new(self, 0)
    }
    #[doc = "Bit 1 - IFR_DISABLE"]
    #[inline(always)]
    pub fn ifr_disable(&mut self) -> IfrDisableW<'_, TrimLockSpec> {
        IfrDisableW::new(self, 1)
    }
    #[doc = "Bits 16:31 - TRIM_LOCK_KEY"]
    #[inline(always)]
    pub fn trim_lock_key(&mut self) -> TrimLockKeyW<'_, TrimLockSpec> {
