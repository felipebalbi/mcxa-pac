...
impl W {
    #[doc = "Bit 0 - Idle operation feature not available in this version (flag is don't care)."]
    #[inline(always)]
    pub fn idleop(&mut self) -> IdleopW<'_, PkcCfgSpec> {
        IdleopW::new(self, 0)
    }
    #[doc = "Bit 1 - RFU"]
    #[inline(always)]
    pub fn rfu1(&mut self) -> Rfu1W<'_, PkcCfgSpec> {
        Rfu1W::new(self, 1)
    }
    #[doc = "Bit 2 - RFU"]
    #[inline(always)]
    pub fn rfu2(&mut self) -> Rfu2W<'_, PkcCfgSpec> {
        Rfu2W::new(self, 2)
    }
    #[doc = "Bit 3 - Clock randomization feature not available in this version (flag is don't care)."]
    #[inline(always)]
    pub fn clkrnd(&mut self) -> ClkrndW<'_, PkcCfgSpec> {
        ClkrndW::new(self, 3)
    }
    #[doc = "Bit 4 - Noise in reduced multiplier mode feature not available in this version (flag is don't care)."]
    #[inline(always)]
    pub fn redmulnoise(&mut self) -> RedmulnoiseW<'_, PkcCfgSpec> {
        RedmulnoiseW::new(self, 4)
    }
    #[doc = "Bits 5:7 - Random delay feature not available in this version (flag is don't care)."]
    #[inline(always)]
    pub fn rnddly(&mut self) -> RnddlyW<'_, PkcCfgSpec> {
        RnddlyW::new(self, 5)
    }
    #[doc = "Bit 8 - Noise feature not available in this version (flag is don't care)."]
    #[inline(always)]
    pub fn sbxnoise(&mut self) -> SbxnoiseW<'_, PkcCfgSpec> {
        SbxnoiseW::new(self, 8)
    }
    #[doc = "Bit 9 - Noise feature not available in this version (flag is don't care)."]
    #[inline(always)]
    pub fn alpnoise(&mut self) -> AlpnoiseW<'_, PkcCfgSpec> {
        AlpnoiseW::new(self, 9)
    }
    #[doc = "Bit 10 - Noise feature not available in this version (flag is don't care)."]
    #[inline(always)]
    pub fn fmulnoise(&mut self) -> FmulnoiseW<'_, PkcCfgSpec> {
