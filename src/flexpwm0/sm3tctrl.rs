...
impl W {
    #[doc = "Bits 0:5 - Output Trigger Enables"]
    #[inline(always)]
    pub fn out_trig_en(&mut self) -> OutTrigEnW<'_, Sm3tctrlSpec> {
        OutTrigEnW::new(self, 0)
    }
    #[doc = "Bit 12 - Trigger Frequency"]
    #[inline(always)]
    pub fn trgfrq(&mut self) -> TrgfrqW<'_, Sm3tctrlSpec> {
        TrgfrqW::new(self, 12)
    }
    #[doc = "Bit 14 - Mux Output Trigger 1 Source Select"]
    #[inline(always)]
    pub fn pwbot1(&mut self) -> Pwbot1W<'_, Sm3tctrlSpec> {
        Pwbot1W::new(self, 14)
    }
    #[doc = "Bit 15 - Mux Output Trigger 0 Source Select"]
    #[inline(always)]
    pub fn pwaot0(&mut self) -> Pwaot0W<'_, Sm3tctrlSpec> {
        Pwaot0W::new(self, 15)
    }
}
