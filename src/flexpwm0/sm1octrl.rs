...
impl W {
    #[doc = "Bits 0:1 - PWM_X Fault State"]
    #[inline(always)]
    pub fn pwmxfs(&mut self) -> PwmxfsW<'_, Sm1octrlSpec> {
        PwmxfsW::new(self, 0)
    }
    #[doc = "Bits 2:3 - PWM_B Fault State"]
    #[inline(always)]
    pub fn pwmbfs(&mut self) -> PwmbfsW<'_, Sm1octrlSpec> {
        PwmbfsW::new(self, 2)
    }
    #[doc = "Bits 4:5 - PWM_A Fault State"]
    #[inline(always)]
    pub fn pwmafs(&mut self) -> PwmafsW<'_, Sm1octrlSpec> {
        PwmafsW::new(self, 4)
    }
    #[doc = "Bit 8 - PWM_X Output Polarity"]
    #[inline(always)]
    pub fn polx(&mut self) -> PolxW<'_, Sm1octrlSpec> {
        PolxW::new(self, 8)
    }
    #[doc = "Bit 9 - PWM_B Output Polarity"]
    #[inline(always)]
    pub fn polb(&mut self) -> PolbW<'_, Sm1octrlSpec> {
        PolbW::new(self, 9)
    }
    #[doc = "Bit 10 - PWM_A Output Polarity"]
    #[inline(always)]
    pub fn pola(&mut self) -> PolaW<'_, Sm1octrlSpec> {
        PolaW::new(self, 10)
    }
}
