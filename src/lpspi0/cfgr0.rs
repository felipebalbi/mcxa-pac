...
impl W {
    #[doc = "Bit 0 - Host Request Enable"]
    #[inline(always)]
    pub fn hren(&mut self) -> HrenW<'_, Cfgr0Spec> {
        HrenW::new(self, 0)
    }
    #[doc = "Bit 1 - Host Request Polarity"]
    #[inline(always)]
    pub fn hrpol(&mut self) -> HrpolW<'_, Cfgr0Spec> {
        HrpolW::new(self, 1)
    }
    #[doc = "Bit 2 - Host Request Select"]
    #[inline(always)]
    pub fn hrsel(&mut self) -> HrselW<'_, Cfgr0Spec> {
        HrselW::new(self, 2)
    }
    #[doc = "Bit 3 - Host Request Direction"]
    #[inline(always)]
    pub fn hrdir(&mut self) -> HrdirW<'_, Cfgr0Spec> {
        HrdirW::new(self, 3)
    }
    #[doc = "Bit 8 - Circular FIFO Enable"]
    #[inline(always)]
    pub fn cirfifo(&mut self) -> CirfifoW<'_, Cfgr0Spec> {
        CirfifoW::new(self, 8)
    }
    #[doc = "Bit 9 - Receive Data Match Only"]
    #[inline(always)]
    pub fn rdmo(&mut self) -> RdmoW<'_, Cfgr0Spec> {
        RdmoW::new(self, 9)
    }
}
