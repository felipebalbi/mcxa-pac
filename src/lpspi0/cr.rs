...
impl W {
    #[doc = "Bit 0 - Module Enable"]
    #[inline(always)]
    pub fn men(&mut self) -> MenW<'_, CrSpec> {
        MenW::new(self, 0)
    }
    #[doc = "Bit 1 - Software Reset"]
    #[inline(always)]
    pub fn rst(&mut self) -> RstW<'_, CrSpec> {
        RstW::new(self, 1)
    }
    #[doc = "Bit 3 - Debug Enable"]
    #[inline(always)]
    pub fn dbgen(&mut self) -> DbgenW<'_, CrSpec> {
        DbgenW::new(self, 3)
    }
    #[doc = "Bit 8 - Reset Transmit FIFO"]
    #[inline(always)]
    pub fn rtf(&mut self) -> RtfW<'_, CrSpec> {
        RtfW::new(self, 8)
    }
    #[doc = "Bit 9 - Reset Receive FIFO"]
    #[inline(always)]
    pub fn rrf(&mut self) -> RrfW<'_, CrSpec> {
        RrfW::new(self, 9)
    }
}
