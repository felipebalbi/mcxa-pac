...
impl W {
    #[doc = "Bits 0:7 - SCK Setup"]
    #[inline(always)]
    pub fn sckset(&mut self) -> ScksetW<'_, Ccr1Spec> {
        ScksetW::new(self, 0)
    }
    #[doc = "Bits 8:15 - SCK Hold"]
    #[inline(always)]
    pub fn sckhld(&mut self) -> SckhldW<'_, Ccr1Spec> {
        SckhldW::new(self, 8)
    }
    #[doc = "Bits 16:23 - PCS to PCS Delay"]
    #[inline(always)]
    pub fn pcspcs(&mut self) -> PcspcsW<'_, Ccr1Spec> {
        PcspcsW::new(self, 16)
    }
    #[doc = "Bits 24:31 - SCK Inter-Frame Delay"]
    #[inline(always)]
    pub fn scksck(&mut self) -> ScksckW<'_, Ccr1Spec> {
        ScksckW::new(self, 24)
    }
}
