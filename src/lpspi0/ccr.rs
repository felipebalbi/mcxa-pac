...
impl W {
    #[doc = "Bits 0:7 - SCK Divider"]
    #[inline(always)]
    pub fn sckdiv(&mut self) -> SckdivW<'_, CcrSpec> {
        SckdivW::new(self, 0)
    }
    #[doc = "Bits 8:15 - Delay Between Transfers"]
    #[inline(always)]
    pub fn dbt(&mut self) -> DbtW<'_, CcrSpec> {
        DbtW::new(self, 8)
    }
    #[doc = "Bits 16:23 - PCS-to-SCK Delay"]
    #[inline(always)]
    pub fn pcssck(&mut self) -> PcssckW<'_, CcrSpec> {
        PcssckW::new(self, 16)
    }
    #[doc = "Bits 24:31 - SCK-to-PCS Delay"]
    #[inline(always)]
    pub fn sckpcs(&mut self) -> SckpcsW<'_, CcrSpec> {
        SckpcsW::new(self, 24)
    }
}
