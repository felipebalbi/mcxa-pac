...
impl W {
    #[doc = "Bit 0 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe16(&mut self) -> Giwe16W<'_, GichrSpec> {
        Giwe16W::new(self, 0)
    }
    #[doc = "Bit 1 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe17(&mut self) -> Giwe17W<'_, GichrSpec> {
        Giwe17W::new(self, 1)
    }
    #[doc = "Bit 2 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe18(&mut self) -> Giwe18W<'_, GichrSpec> {
        Giwe18W::new(self, 2)
    }
    #[doc = "Bit 3 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe19(&mut self) -> Giwe19W<'_, GichrSpec> {
        Giwe19W::new(self, 3)
    }
    #[doc = "Bit 4 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe20(&mut self) -> Giwe20W<'_, GichrSpec> {
        Giwe20W::new(self, 4)
    }
    #[doc = "Bit 5 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe21(&mut self) -> Giwe21W<'_, GichrSpec> {
        Giwe21W::new(self, 5)
    }
    #[doc = "Bit 6 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe22(&mut self) -> Giwe22W<'_, GichrSpec> {
        Giwe22W::new(self, 6)
    }
    #[doc = "Bit 7 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe23(&mut self) -> Giwe23W<'_, GichrSpec> {
        Giwe23W::new(self, 7)
    }
    #[doc = "Bit 8 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe24(&mut self) -> Giwe24W<'_, GichrSpec> {
        Giwe24W::new(self, 8)
    }
    #[doc = "Bit 9 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe25(&mut self) -> Giwe25W<'_, GichrSpec> {
        Giwe25W::new(self, 9)
    }
    #[doc = "Bit 10 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe26(&mut self) -> Giwe26W<'_, GichrSpec> {
        Giwe26W::new(self, 10)
    }
    #[doc = "Bit 11 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe27(&mut self) -> Giwe27W<'_, GichrSpec> {
        Giwe27W::new(self, 11)
    }
    #[doc = "Bit 12 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe28(&mut self) -> Giwe28W<'_, GichrSpec> {
        Giwe28W::new(self, 12)
    }
    #[doc = "Bit 13 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe29(&mut self) -> Giwe29W<'_, GichrSpec> {
        Giwe29W::new(self, 13)
    }
    #[doc = "Bit 14 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe30(&mut self) -> Giwe30W<'_, GichrSpec> {
        Giwe30W::new(self, 14)
    }
    #[doc = "Bit 15 - Global Interrupt Write Enable"]
    #[inline(always)]
    pub fn giwe31(&mut self) -> Giwe31W<'_, GichrSpec> {
        Giwe31W::new(self, 15)
    }
    #[doc = "Bits 16:31 - Global Interrupt Write Data"]
    #[inline(always)]
