...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("MBC0_MEMN_GLBAC5")
            .field("nux", &self.nux())
            .field("nuw", &self.nuw())
            .field("nur", &self.nur())
            .field("npx", &self.npx())
...
impl W {
    #[doc = "Bit 0 - NonsecureUser Execute"]
    #[inline(always)]
    pub fn nux(&mut self) -> NuxW<'_, Mbc0MemnGlbac5Spec> {
        NuxW::new(self, 0)
    }
    #[doc = "Bit 1 - NonsecureUser Write"]
    #[inline(always)]
    pub fn nuw(&mut self) -> NuwW<'_, Mbc0MemnGlbac5Spec> {
        NuwW::new(self, 1)
    }
    #[doc = "Bit 2 - NonsecureUser Read"]
    #[inline(always)]
    pub fn nur(&mut self) -> NurW<'_, Mbc0MemnGlbac5Spec> {
        NurW::new(self, 2)
    }
    #[doc = "Bit 4 - NonsecurePriv Execute"]
    #[inline(always)]
    pub fn npx(&mut self) -> NpxW<'_, Mbc0MemnGlbac5Spec> {
        NpxW::new(self, 4)
    }
    #[doc = "Bit 5 - NonsecurePriv Write"]
    #[inline(always)]
    pub fn npw(&mut self) -> NpwW<'_, Mbc0MemnGlbac5Spec> {
        NpwW::new(self, 5)
    }
    #[doc = "Bit 6 - NonsecurePriv Read"]
    #[inline(always)]
    pub fn npr(&mut self) -> NprW<'_, Mbc0MemnGlbac5Spec> {
        NprW::new(self, 6)
    }
    #[doc = "Bit 8 - SecureUser Execute"]
    #[inline(always)]
    pub fn sux(&mut self) -> SuxW<'_, Mbc0MemnGlbac5Spec> {
        SuxW::new(self, 8)
    }
    #[doc = "Bit 9 - SecureUser Write"]
    #[inline(always)]
    pub fn suw(&mut self) -> SuwW<'_, Mbc0MemnGlbac5Spec> {
        SuwW::new(self, 9)
    }
    #[doc = "Bit 10 - SecureUser Read"]
    #[inline(always)]
    pub fn sur(&mut self) -> SurW<'_, Mbc0MemnGlbac5Spec> {
        SurW::new(self, 10)
    }
    #[doc = "Bit 12 - SecurePriv Execute"]
    #[inline(always)]
    pub fn spx(&mut self) -> SpxW<'_, Mbc0MemnGlbac5Spec> {
        SpxW::new(self, 12)
    }
    #[doc = "Bit 13 - SecurePriv Write"]
    #[inline(always)]
    pub fn spw(&mut self) -> SpwW<'_, Mbc0MemnGlbac5Spec> {
        SpwW::new(self, 13)
    }
    #[doc = "Bit 14 - SecurePriv Read"]
    #[inline(always)]
    pub fn spr(&mut self) -> SprW<'_, Mbc0MemnGlbac5Spec> {
        SprW::new(self, 14)
    }
    #[doc = "Bit 31 - LOCK"]
    #[inline(always)]
    pub fn lk(&mut self) -> LkW<'_, Mbc0MemnGlbac5Spec> {
        LkW::new(self, 31)
    }
}
