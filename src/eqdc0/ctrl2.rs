...
impl W {
    #[doc = "Bit 0 - Update Hold Registers"]
    #[inline(always)]
    pub fn updhld(&mut self) -> UpdhldW<'_, Ctrl2Spec> {
        UpdhldW::new(self, 0)
    }
    #[doc = "Bit 1 - Update Position Registers"]
    #[inline(always)]
    pub fn updpos(&mut self) -> UpdposW<'_, Ctrl2Spec> {
        UpdposW::new(self, 1)
    }
    #[doc = "Bit 2 - Operation Mode Select"]
    #[inline(always)]
    pub fn opmode(&mut self) -> OpmodeW<'_, Ctrl2Spec> {
        OpmodeW::new(self, 2)
    }
    #[doc = "Bit 3 - Buffered Register Load (Update) Mode Select"]
    #[inline(always)]
    pub fn ldmod(&mut self) -> LdmodW<'_, Ctrl2Spec> {
        LdmodW::new(self, 3)
    }
    #[doc = "Bit 8 - Revolution Counter Modulus Enable"]
    #[inline(always)]
    pub fn revmod(&mut self) -> RevmodW<'_, Ctrl2Spec> {
        RevmodW::new(self, 8)
    }
    #[doc = "Bit 9 - Output Control"]
    #[inline(always)]
    pub fn outctl(&mut self) -> OutctlW<'_, Ctrl2Spec> {
        OutctlW::new(self, 9)
    }
    #[doc = "Bit 10 - Period measurement function enable"]
    #[inline(always)]
    pub fn pmen(&mut self) -> PmenW<'_, Ctrl2Spec> {
        PmenW::new(self, 10)
    }
    #[doc = "Bit 11 - Enables/disables the position counter to be initialized by Index Event Edge Mark"]
    #[inline(always)]
    pub fn emip(&mut self) -> EmipW<'_, Ctrl2Spec> {
        EmipW::new(self, 11)
    }
    #[doc = "Bit 12 - Initial Position Register"]
    #[inline(always)]
    pub fn initpos(&mut self) -> InitposW<'_, Ctrl2Spec> {
        InitposW::new(self, 12)
    }
    #[doc = "Bit 13 - Count Once"]
    #[inline(always)]
    pub fn once(&mut self) -> OnceW<'_, Ctrl2Spec> {
        OnceW::new(self, 13)
    }
    #[doc = "Bits 14:15 - Counting Mode"]
    #[inline(always)]
    pub fn cmode(&mut self) -> CmodeW<'_, Ctrl2Spec> {
        CmodeW::new(self, 14)
    }
}
