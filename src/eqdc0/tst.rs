...
impl W {
    #[doc = "Bits 0:7 - TEST_COUNT"]
    #[inline(always)]
    pub fn test_count(&mut self) -> TestCountW<'_, TstSpec> {
        TestCountW::new(self, 0)
    }
    #[doc = "Bits 8:12 - TEST_PERIOD"]
    #[inline(always)]
    pub fn test_period(&mut self) -> TestPeriodW<'_, TstSpec> {
        TestPeriodW::new(self, 8)
    }
    #[doc = "Bit 13 - Quadrature Decoder Negative Signal"]
    #[inline(always)]
    pub fn qdn(&mut self) -> QdnW<'_, TstSpec> {
        QdnW::new(self, 13)
    }
    #[doc = "Bit 14 - Test Counter Enable"]
    #[inline(always)]
    pub fn tce(&mut self) -> TceW<'_, TstSpec> {
        TceW::new(self, 14)
    }
    #[doc = "Bit 15 - Test Mode Enable"]
    #[inline(always)]
    pub fn ten(&mut self) -> TenW<'_, TstSpec> {
        TenW::new(self, 15)
    }
}
