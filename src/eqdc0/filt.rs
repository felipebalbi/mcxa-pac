...
impl W {
    #[doc = "Bits 0:7 - Input Filter Sample Period"]
    #[inline(always)]
    pub fn filt_per(&mut self) -> FiltPerW<'_, FiltSpec> {
        FiltPerW::new(self, 0)
    }
    #[doc = "Bits 8:10 - Input Filter Sample Count"]
    #[inline(always)]
    pub fn filt_cnt(&mut self) -> FiltCntW<'_, FiltSpec> {
        FiltCntW::new(self, 8)
    }
    #[doc = "Bit 11 - Filter Clock Source selection"]
    #[inline(always)]
    pub fn filt_cs(&mut self) -> FiltCsW<'_, FiltSpec> {
        FiltCsW::new(self, 11)
    }
    #[doc = "Bits 12:15 - Prescaler"]
    #[inline(always)]
    pub fn prsc(&mut self) -> PrscW<'_, FiltSpec> {
        PrscW::new(self, 12)
    }
}
