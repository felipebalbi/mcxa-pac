...
impl W {
    #[doc = "Bit 0 - FLEXPWM1"]
    #[inline(always)]
    pub fn flexpwm1(&mut self) -> Flexpwm1W<'_, MrccGlbAcc1Spec> {
    ...
    #[doc = "Bit 6 - CMP2"]
    #[inline(always)]
    pub fn cmp2(&mut self) -> Cmp2W<'_, MrccGlbAcc1Spec> {
        Cmp2W::new(self, 6)
    }
    #[doc = "Bit 7 - DAC0"]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - OPAMP1"]
    #[inline(always)]
    pub fn opamp1(&mut self) -> Opamp1W<'_, MrccGlbAcc1Spec> {
        Opamp1W::new(self, 9)
    }
    #[doc = "Bit 10 - OPAMP2"]
    #[inline(always)]
    pub fn opamp2(&mut self) -> Opamp2W<'_, MrccGlbAcc1Spec> {
        Opamp2W::new(self, 10)
    }
    #[doc = "Bit 11 - OPAMP3"]
    #[inline(always)]
    pub fn opamp3(&mut self) -> Opamp3W<'_, MrccGlbAcc1Spec> {
        Opamp3W::new(self, 11)
    }
    #[doc = "Bit 12 - PORT0"]
    #[inline(always)]
    ...
    #[doc = "Bit 17 - SLCD0"]
    #[inline(always)]
    pub fn slcd0(&mut self) -> Slcd0W<'_, MrccGlbAcc1Spec> {
        Slcd0W::new(self, 17)
    }
    #[doc = "Bit 18 - FLEXCAN0"]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - FLEXCAN1"]
    #[inline(always)]
    pub fn flexcan1(&mut self) -> Flexcan1W<'_, MrccGlbAcc1Spec> {
    ...
    #[doc = "Bit 22 - LPUART5"]
    #[inline(always)]
    pub fn lpuart5(&mut self) -> Lpuart5W<'_, MrccGlbAcc1Spec> {
        Lpuart5W::new(self, 22)
    }
    #[doc = "Bit 24 - PKC0"]
    #[inline(always)]
    pub fn pkc0(&mut self) -> Pkc0W<'_, MrccGlbAcc1Spec> {
        Pkc0W::new(self, 24)
    }
    #[doc = "Bit 25 - SGI0"]
    #[inline(always)]
    pub fn sgi0(&mut self) -> Sgi0W<'_, MrccGlbAcc1Spec> {
        Sgi0W::new(self, 25)
    }
    #[doc = "Bit 26 - TRNG0"]
    #[inline(always)]
    pub fn trng0(&mut self) -> Trng0W<'_, MrccGlbAcc1Spec> {
        Trng0W::new(self, 26)
    }
    #[doc = "Bit 27 - UDF0"]
    #[inline(always)]
    pub fn udf0(&mut self) -> Udf0W<'_, MrccGlbAcc1Spec> {
        Udf0W::new(self, 27)
    }
    #[doc = "Bit 28 - ADC2"]
    #[inline(always)]
    pub fn adc2(&mut self) -> Adc2W<'_, MrccGlbAcc1Spec> {
        Adc2W::new(self, 28)
    }
    #[doc = "Bit 29 - ADC3"]
    #[inline(always)]
    pub fn adc3(&mut self) -> Adc3W<'_, MrccGlbAcc1Spec> {
        Adc3W::new(self, 29)
    }
}
