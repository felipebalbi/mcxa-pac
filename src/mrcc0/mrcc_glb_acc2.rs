...
impl W {
    #[doc = "Bit 1 - RAMA"]
    #[inline(always)]
    pub fn rama(&mut self) -> RamaW<'_, MrccGlbAcc2Spec> {
        RamaW::new(self, 1)
    }
    #[doc = "Bit 2 - RAMB"]
    #[inline(always)]
    pub fn ramb(&mut self) -> RambW<'_, MrccGlbAcc2Spec> {
        RambW::new(self, 2)
    }
    #[doc = "Bit 3 - RAMC"]
    #[inline(always)]
    pub fn ramc(&mut self) -> RamcW<'_, MrccGlbAcc2Spec> {
        RamcW::new(self, 3)
    }
    #[doc = "Bit 4 - GPIO0"]
    #[inline(always)]
    pub fn gpio0(&mut self) -> Gpio0W<'_, MrccGlbAcc2Spec> {
        Gpio0W::new(self, 4)
    }
    #[doc = "Bit 5 - GPIO1"]
    #[inline(always)]
    pub fn gpio1(&mut self) -> Gpio1W<'_, MrccGlbAcc2Spec> {
        Gpio1W::new(self, 5)
    }
    #[doc = "Bit 6 - GPIO2"]
    #[inline(always)]
    pub fn gpio2(&mut self) -> Gpio2W<'_, MrccGlbAcc2Spec> {
        Gpio2W::new(self, 6)
    }
    #[doc = "Bit 7 - GPIO3"]
    #[inline(always)]
    pub fn gpio3(&mut self) -> Gpio3W<'_, MrccGlbAcc2Spec> {
        Gpio3W::new(self, 7)
    }
    #[doc = "Bit 8 - GPIO4"]
    #[inline(always)]
    pub fn gpio4(&mut self) -> Gpio4W<'_, MrccGlbAcc2Spec> {
        Gpio4W::new(self, 8)
    }
    #[doc = "Bit 9 - MAU0"]
    #[inline(always)]
    pub fn mau0(&mut self) -> Mau0W<'_, MrccGlbAcc2Spec> {
        Mau0W::new(self, 9)
    }
    #[doc = "Bit 10 - ROMC"]
    #[inline(always)]
    pub fn romc(&mut self) -> RomcW<'_, MrccGlbAcc2Spec> {
        RomcW::new(self, 10)
    }
}
