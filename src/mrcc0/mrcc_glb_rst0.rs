...
impl W {
    #[doc = "Bit 0 - INPUTMUX0"]
    #[inline(always)]
    pub fn inputmux0(&mut self) -> Inputmux0W<'_, MrccGlbRst0Spec> {
        Inputmux0W::new(self, 0)
    }
    #[doc = "Bit 1 - I3C0"]
    #[inline(always)]
    pub fn i3c0(&mut self) -> I3c0W<'_, MrccGlbRst0Spec> {
        I3c0W::new(self, 1)
    }
    #[doc = "Bit 2 - CTIMER0"]
    #[inline(always)]
    pub fn ctimer0(&mut self) -> Ctimer0W<'_, MrccGlbRst0Spec> {
        Ctimer0W::new(self, 2)
    }
    #[doc = "Bit 3 - CTIMER1"]
    #[inline(always)]
    pub fn ctimer1(&mut self) -> Ctimer1W<'_, MrccGlbRst0Spec> {
        Ctimer1W::new(self, 3)
    }
    #[doc = "Bit 4 - CTIMER2"]
    #[inline(always)]
    pub fn ctimer2(&mut self) -> Ctimer2W<'_, MrccGlbRst0Spec> {
        Ctimer2W::new(self, 4)
    }
    #[doc = "Bit 5 - CTIMER3"]
    #[inline(always)]
    pub fn ctimer3(&mut self) -> Ctimer3W<'_, MrccGlbRst0Spec> {
        Ctimer3W::new(self, 5)
    }
    #[doc = "Bit 6 - CTIMER4"]
    #[inline(always)]
    pub fn ctimer4(&mut self) -> Ctimer4W<'_, MrccGlbRst0Spec> {
        Ctimer4W::new(self, 6)
    }
    #[doc = "Bit 7 - FREQME"]
    #[inline(always)]
    pub fn freqme(&mut self) -> FreqmeW<'_, MrccGlbRst0Spec> {
        FreqmeW::new(self, 7)
    }
    #[doc = "Bit 8 - UTICK0"]
    #[inline(always)]
    pub fn utick0(&mut self) -> Utick0W<'_, MrccGlbRst0Spec> {
        Utick0W::new(self, 8)
    }
    #[doc = "Bit 10 - SMARTDMA0"]
    #[inline(always)]
    pub fn smartdma0(&mut self) -> Smartdma0W<'_, MrccGlbRst0Spec> {
        Smartdma0W::new(self, 10)
    }
    #[doc = "Bit 11 - DMA0"]
    #[inline(always)]
    pub fn dma0(&mut self) -> Dma0W<'_, MrccGlbRst0Spec> {
        Dma0W::new(self, 11)
    }
    #[doc = "Bit 12 - AOI0"]
    #[inline(always)]
    pub fn aoi0(&mut self) -> Aoi0W<'_, MrccGlbRst0Spec> {
        Aoi0W::new(self, 12)
    }
    #[doc = "Bit 13 - CRC0"]
    #[inline(always)]
    pub fn crc0(&mut self) -> Crc0W<'_, MrccGlbRst0Spec> {
        Crc0W::new(self, 13)
    }
    #[doc = "Bit 14 - EIM0"]
    #[inline(always)]
    pub fn eim0(&mut self) -> Eim0W<'_, MrccGlbRst0Spec> {
        Eim0W::new(self, 14)
    }
    #[doc = "Bit 15 - ERM0"]
    #[inline(always)]
    pub fn erm0(&mut self) -> Erm0W<'_, MrccGlbRst0Spec> {
        Erm0W::new(self, 15)
    }
    #[doc = "Bit 17 - AOI1"]
    #[inline(always)]
    pub fn aoi1(&mut self) -> Aoi1W<'_, MrccGlbRst0Spec> {
        Aoi1W::new(self, 17)
    }
    #[doc = "Bit 18 - FLEXIO0"]
    #[inline(always)]
    pub fn flexio0(&mut self) -> Flexio0W<'_, MrccGlbRst0Spec> {
        Flexio0W::new(self, 18)
    }
    #[doc = "Bit 19 - LPI2C0"]
    #[inline(always)]
    pub fn lpi2c0(&mut self) -> Lpi2c0W<'_, MrccGlbRst0Spec> {
        Lpi2c0W::new(self, 19)
    }
    #[doc = "Bit 20 - LPI2C1"]
    #[inline(always)]
    pub fn lpi2c1(&mut self) -> Lpi2c1W<'_, MrccGlbRst0Spec> {
        Lpi2c1W::new(self, 20)
    }
    #[doc = "Bit 21 - LPSPI0"]
    #[inline(always)]
    pub fn lpspi0(&mut self) -> Lpspi0W<'_, MrccGlbRst0Spec> {
        Lpspi0W::new(self, 21)
    }
    #[doc = "Bit 22 - LPSPI1"]
    #[inline(always)]
    pub fn lpspi1(&mut self) -> Lpspi1W<'_, MrccGlbRst0Spec> {
        Lpspi1W::new(self, 22)
    }
    #[doc = "Bit 23 - LPUART0"]
    #[inline(always)]
    pub fn lpuart0(&mut self) -> Lpuart0W<'_, MrccGlbRst0Spec> {
        Lpuart0W::new(self, 23)
    }
    #[doc = "Bit 24 - LPUART1"]
    #[inline(always)]
    pub fn lpuart1(&mut self) -> Lpuart1W<'_, MrccGlbRst0Spec> {
        Lpuart1W::new(self, 24)
    }
    #[doc = "Bit 25 - LPUART2"]
    #[inline(always)]
    pub fn lpuart2(&mut self) -> Lpuart2W<'_, MrccGlbRst0Spec> {
        Lpuart2W::new(self, 25)
    }
    #[doc = "Bit 26 - LPUART3"]
    #[inline(always)]
    pub fn lpuart3(&mut self) -> Lpuart3W<'_, MrccGlbRst0Spec> {
        Lpuart3W::new(self, 26)
    }
    #[doc = "Bit 27 - LPUART4"]
    #[inline(always)]
    pub fn lpuart4(&mut self) -> Lpuart4W<'_, MrccGlbRst0Spec> {
        Lpuart4W::new(self, 27)
    }
    #[doc = "Bit 28 - USB0"]
    #[inline(always)]
    pub fn usb0(&mut self) -> Usb0W<'_, MrccGlbRst0Spec> {
        Usb0W::new(self, 28)
    }
    #[doc = "Bit 29 - QDC0"]
    #[inline(always)]
    pub fn qdc0(&mut self) -> Qdc0W<'_, MrccGlbRst0Spec> {
        Qdc0W::new(self, 29)
    }
    #[doc = "Bit 30 - QDC1"]
    #[inline(always)]
    pub fn qdc1(&mut self) -> Qdc1W<'_, MrccGlbRst0Spec> {
        Qdc1W::new(self, 30)
    }
    #[doc = "Bit 31 - FLEXPWM0"]
    #[inline(always)]
    pub fn flexpwm0(&mut self) -> Flexpwm0W<'_, MrccGlbRst0Spec> {
