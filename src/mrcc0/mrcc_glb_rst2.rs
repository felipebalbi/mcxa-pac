...
impl W {
    #[doc = "Bit 4 - GPIO0"]
    #[inline(always)]
    pub fn gpio0(&mut self) -> Gpio0W<'_, MrccGlbRst2Spec> {
        Gpio0W::new(self, 4)
    }
    #[doc = "Bit 5 - GPIO1"]
    #[inline(always)]
    pub fn gpio1(&mut self) -> Gpio1W<'_, MrccGlbRst2Spec> {
        Gpio1W::new(self, 5)
    }
    #[doc = "Bit 6 - GPIO2"]
    #[inline(always)]
    pub fn gpio2(&mut self) -> Gpio2W<'_, MrccGlbRst2Spec> {
        Gpio2W::new(self, 6)
    }
    #[doc = "Bit 7 - GPIO3"]
    #[inline(always)]
    pub fn gpio3(&mut self) -> Gpio3W<'_, MrccGlbRst2Spec> {
        Gpio3W::new(self, 7)
    }
    #[doc = "Bit 8 - GPIO4"]
    #[inline(always)]
    pub fn gpio4(&mut self) -> Gpio4W<'_, MrccGlbRst2Spec> {
        Gpio4W::new(self, 8)
    }
    #[doc = "Bit 9 - MAU0"]
    #[inline(always)]
    pub fn mau0(&mut self) -> Mau0W<'_, MrccGlbRst2Spec> {
        Mau0W::new(self, 9)
    }
}
