...
impl W {
    #[doc = "Bit 0 - Module Interrupt Wake-up Enable for Module 0"]
    #[inline(always)]
    pub fn wume0(&mut self) -> Wume0W<'_, MeSpec> {
        Wume0W::new(self, 0)
    }
    #[doc = "Bit 1 - Module Interrupt Wake-up Enable for Module 1"]
    #[inline(always)]
    pub fn wume1(&mut self) -> Wume1W<'_, MeSpec> {
        Wume1W::new(self, 1)
    }
    #[doc = "Bit 2 - Module Interrupt Wake-up Enable for Module 2"]
    #[inline(always)]
    pub fn wume2(&mut self) -> Wume2W<'_, MeSpec> {
        Wume2W::new(self, 2)
    }
    #[doc = "Bit 3 - Module Interrupt Wake-up Enable for Module 3"]
    #[inline(always)]
    pub fn wume3(&mut self) -> Wume3W<'_, MeSpec> {
        Wume3W::new(self, 3)
    }
    #[doc = "Bit 6 - Module Interrupt Wake-up Enable for Module 6"]
    #[inline(always)]
    pub fn wume6(&mut self) -> Wume6W<'_, MeSpec> {
        Wume6W::new(self, 6)
    }
    #[doc = "Bit 8 - Module Interrupt Wake-up Enable for Module 8"]
    #[inline(always)]
    pub fn wume8(&mut self) -> Wume8W<'_, MeSpec> {
        Wume8W::new(self, 8)
    }
}
