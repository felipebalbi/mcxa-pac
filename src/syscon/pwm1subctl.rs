...
impl W {
    #[doc = "Bit 0 - Enables PWM1 SUB Clock0"]
    #[inline(always)]
    pub fn clk0_en(&mut self) -> Clk0EnW<'_, Pwm1subctlSpec> {
        Clk0EnW::new(self, 0)
    }
    #[doc = "Bit 1 - Enables PWM1 SUB Clock1"]
    #[inline(always)]
    pub fn clk1_en(&mut self) -> Clk1EnW<'_, Pwm1subctlSpec> {
        Clk1EnW::new(self, 1)
    }
    #[doc = "Bit 2 - Enables PWM1 SUB Clock2"]
    #[inline(always)]
    pub fn clk2_en(&mut self) -> Clk2EnW<'_, Pwm1subctlSpec> {
        Clk2EnW::new(self, 2)
    }
    #[doc = "Bit 3 - Enables PWM1 SUB Clock3"]
    #[inline(always)]
    pub fn clk3_en(&mut self) -> Clk3EnW<'_, Pwm1subctlSpec> {
        Clk3EnW::new(self, 3)
    }
}
