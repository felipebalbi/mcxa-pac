...
impl W {
    #[doc = "Bit 0 - Clear the HW_ERR interrupt."]
    #[inline(always)]
    pub fn hw_err(&mut self) -> HwErrW<'_, IntCtrlSpec> {
        HwErrW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear the ENT_VAL interrupt."]
    #[inline(always)]
    pub fn ent_val(&mut self) -> EntValW<'_, IntCtrlSpec> {
        EntValW::new(self, 1)
    }
    #[doc = "Bit 2 - Clear the FRQ_CT_FAIL interrupt."]
    #[inline(always)]
    pub fn frq_ct_fail(&mut self) -> FrqCtFailW<'_, IntCtrlSpec> {
        FrqCtFailW::new(self, 2)
    }
    #[doc = "Bit 3 - Clear the INTG_FLT interrupt."]
    #[inline(always)]
    pub fn intg_flt(&mut self) -> IntgFltW<'_, IntCtrlSpec> {
        IntgFltW::new(self, 3)
    }
}
