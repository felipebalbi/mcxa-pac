...
impl W {
    #[doc = "Bit 0 - Mask the HW_ERR interrupt."]
    #[inline(always)]
    pub fn hw_err(&mut self) -> HwErrW<'_, IntMaskSpec> {
        HwErrW::new(self, 0)
    }
    #[doc = "Bit 1 - Mask the ENT_VAL interrupt."]
    #[inline(always)]
    pub fn ent_val(&mut self) -> EntValW<'_, IntMaskSpec> {
        EntValW::new(self, 1)
    }
    #[doc = "Bit 2 - Mask the FRQ_CT_FAIL interrupt."]
    #[inline(always)]
    pub fn frq_ct_fail(&mut self) -> FrqCtFailW<'_, IntMaskSpec> {
        FrqCtFailW::new(self, 2)
    }
    #[doc = "Bit 3 - Mask the INTG_FLT interrupt."]
    #[inline(always)]
    pub fn intg_flt(&mut self) -> IntgFltW<'_, IntMaskSpec> {
        IntgFltW::new(self, 3)
    }
}
